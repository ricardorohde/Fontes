inherited frmRelatorioHistoricoVendasCliente: TfrmRelatorioHistoricoVendasCliente
  ...
  inherited pnPrincipal: TAdvPanel
    ...
    object AdvGroupBox5: TAdvGroupBox
      ...
      object cbRelatorio: TComboBox
        ...
        ParentFont = False
        TabOrder = 0
        Text = 'Somat'#243'ria de vendas'
        Items.Strings = (
          'Resumido'
          'Detalhado'
          'Somat'#243'ria de vendas')
      end
    end
  end
  ...
  object qrVenda: TUniQuery
    ...
    SQL.Strings = (
      ...
      'u.usu_002 as nome_usuario,'
        ...
        'cast(case v.ven_024 when '#39'M'#39'  then m.mes_002 when '#39'B'#39' then '#39'Balc' +
        #227'o'#39' when '#39'C'#39' then concat('#39'COMANDA'#39', '#39' '#39',  v.ven_026 ) when '#39'D'#39' t' +
        'hen '#39'Delivery'#39'  when '#39'P'#39' then '#39'PDV'#39' else '#39'Outro'#39' end as varchar(' +
        '100)) as tipo_venda,'
  ...
  object RelHistoricoVendasSomatoria: TfrxReport
    Version = '5.1.5'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo1: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'HIST'#211'RICO DE VENDAS - SOMAT'#211'RIO')
          ParentFont = False
        end
        object Line1: TfrxLineView
          Align = baCenter
          Left = 0.000231889763800008
          Top = 18.897650000000000000
