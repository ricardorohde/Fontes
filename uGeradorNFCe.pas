...
uses Uni, ACBrNFe, System.Math, System.SysUtils, System.StrUtils,
  System.Classes, pcnConversao, AcbrUtil, ACBrNFeDANFeRLClass, DateUtils,
  pcnRetConsReciNFe, pcnConversaoNFe, pcnNFe, ACBrDANFCeFortesFr, ACBrDFeSSL;
...
public
  ...
  function addFormasPagto(const formaPagto: Integer; const valor: Currency;
    const admCartao: Integer): Boolean;
...
begin
  ...
  self.DANFE.MostrarPreview := false;
...
begin
  ...
  try
    ...
    begin
      ...
      Ide.natOp := 'VENDA';
      Ide.indPag := ipVista; // **** tratar quando for prazo tb...
      Ide.modelo := 65;
      ...
      begin
        ...
        Ide.xJust  := FACBrNFe.justificativa_contingencia; // motivo da entra em contingência
      end
      else
        Ide.tpEmis := teNormal;
      ...
      begin
        ...
        // partilha do ICMS e fundo de probreza... kct, pobre sou eu! :P
        ...
        // produto.Imposto.COFINS.vBCProd     := StrToFloatDef( ObterValorCampo( prodObj.Get('COFINS_vBCProd') ), 0 );
...
var
  ...
  lr_TotalLei12741, lr_TotalDescto, lr_TotalVenda, lr_TotalAcresc,
    lr_ProdDescto, lr_ProdAcresc, lr_ProdLei12741, lr_ICMS_Perc, lr_ICMS_Valor,
...
begin
  try
    ...
    begin
      ...
      begin
        ls_ICMS := FormatFloat('00', qrProdutos.FieldByName('ICMS_CST')
          .AsInteger);
      end
      else
      begin
...
function AutorizarNFCe.addFormasPagto(const formaPagto: Integer;
  const valor: Currency; const admCartao: Integer): Boolean;
var
  iLen: Integer;
begin
  try
