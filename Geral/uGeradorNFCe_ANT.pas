...
uses Uni, ACBrNFe, System.Math, System.SysUtils, System.StrUtils,
  ...
  pcnRetConsReciNFe, pcnConversaoNFe, pcnNFe, ACBrDANFCeFortesFr, Winapi.Messages, ACBrDFeSSL;
...
begin
  ...
  str_sql:= ' SELECT ''P'' AS Ambiente '+ // Arrumar
            ...
            ' , c.cli_004 AS CpfCnpjCliente '+
            ' , c.cli_002 AS Cliente '+
...
var
  ...
  lr_TotalLei12741, lr_TotalDescto, lr_TotalVenda, lr_TotalAcresc,
    lr_ProdDescto, lr_ProdAcresc, lr_ProdLei12741, lr_ICMS_Perc,lr_ICMS_vBC, lr_ICMS_Valor,
...
begin
  try
    ...
    begin
      ...
      lr_ICMS_vBC  := lr_ProdSubTotal;//tratar futuramente casos de Redução de base
      ...
      autNFCe.addProduto(qrProdutos.FieldByName('codigo').AsString,
        ...
        lr_ICMS_Perc,  lr_ICMS_vBC ,lr_ICMS_Valor, ls_PIS, lr_PIS_BC, lr_PIS_Perc,
